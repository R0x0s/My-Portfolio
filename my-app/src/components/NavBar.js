      ...
      <Container>
        ...
        <Navbar.Collapse id="basic-navbar-nav">
          <Nav className="me-auto">
            ...
            <Nav.Link href="#skills" className={activateLink === 'skills' ? 'activate navbar-link' : 'navbar-link'} onClick={()=> onUpdateActivateLink('skills')}>Skills</Nav.Link>
            <Nav.Link href="#project"className= {activateLink === 'projects' ? 'activate navbar-link' : 'navbar-link'} onClick={()=> onUpdateActivateLink('project')}>Projects</Nav.Link>
          </Nav>
